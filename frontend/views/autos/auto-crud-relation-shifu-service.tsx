...
import RelationShifuServiceModel
    from "Frontend/generated/com/jvlang/housekeeping/pojo/entity/RelationShifuServiceModel";
import {GridColumn} from "@hilla/react-components/GridColumn.js";
import {Upload} from "@hilla/react-components/Upload";

export default function RelationShifuServiceEndpointCrud() {
    const uploadHeader = {type: "rela_shifu_service", Authorization: localStorage.getItem("auth_token")};
    return (
        <div className="p-m">
